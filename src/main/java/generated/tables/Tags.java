...
public class Tags extends TableImpl<TagsRecord> {
	...
	private static final long serialVersionUID = -281569439;
	...
	/**
	 * The column <code>public.tags.receipts_id</code>.
	 */
	public final TableField<TagsRecord, Integer> RECEIPTS_ID = createField("receipts_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
